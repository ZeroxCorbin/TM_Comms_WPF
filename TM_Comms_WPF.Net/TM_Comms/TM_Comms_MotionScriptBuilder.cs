...
namespace TM_Comms_WPF.Net
{
    ...
    public class TM_Comms_MotionScriptBuilder
    {
        ...
        public TM_Comms_MotionScriptBuilder()
        {
            Moves = new List<MoveStep>();
        }

        public TM_Comms_MotionScriptBuilder(List<MoveStep> moves)
        {
            Moves = moves;
        }
        ...
        public TM_Comms_ListenNode BuildScriptData()
        {
            ...
            return new TM_Comms_ListenNode(TM_Comms_ListenNode.HEADERS.TMSCT, sb.ToString());
        }
