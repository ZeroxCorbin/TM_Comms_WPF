...
namespace TM_Comms_WPF
{
    public partial class ListenNode
    {
        ...
        public string Message
        {
            ...
            {
                if(Header == HEADERS.TMSCT)
                    return StartByte + HeaderString + Separator + Length.ToString() + Separator + ScriptID.ToString() + Separator + Data + Separator + ChecksumSign + ChecksumString + EndBytes;
                return StartByte + HeaderString + Separator + Length.ToString() + Separator + "00" + Separator + ChecksumSign + ChecksumString + EndBytes;
            }
        }
        ...
        private byte CalCheckSum()
        {
            ...
            Byte[] bData;
            if (Header == HEADERS.TMSCT)
                bData = Encoding.ASCII.GetBytes(HeaderString + Separator + Length.ToString() + Separator + ScriptID.ToString() + Separator + Data + Separator);
            else
                bData = Encoding.ASCII.GetBytes(HeaderString + Separator + Length.ToString() + Separator + "00" + Separator);
